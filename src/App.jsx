...
const CONNECTIVITY_BADGE_HIDDEN_PATHS = new Set([
  ...
  "/reports/personnel-activity",
  "/reports/safety",
  "/reports/next-day-plan",
  ...
  "/admin/inspections",
  "/approval_projects",
  "/admin/inspection-details/",
  "/viewprojects/project-edit/",
  "/admin/project/",
  "/pending_approval",
  "/admin/inspection-item/",
  "/admin/reports/aut",
  "/admin/reports/utreport",
  "/admin/reports/visual",
  "/admin/reports/mut",
  "/admin/reports/detailed",
  "/admin/reports/integrity",
  "/admin-dashboard",
  "/admin/users",
  "/admin/addusers",
  "/admin/edit-user/",
  "/admin/addInspectionTemp",
  "/projects",
  "/admin/projects",
  "/admin/external-feedback",
  "/Client",
  "/location",
  "/admin/company-profile",
  "/admin/company-profile-readonly",
  "/inspection_type",
  "/equipment",
